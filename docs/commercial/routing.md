...
- [ ] Кастомный Jinja-шаблон подписки в Marzban с routing-блоком
- [ ] outbound "direct" настроен
- [ ] outbound "chain-to-eu" настроен (S_RU → S2)
- [ ] Cron автообновления geoip/geosite
- [ ] Тестирование: RU-домен идёт напрямую (проверить внешний IP на ru-сайте)
- [ ] Тестирование: мировой домен идёт через S_RU→S2 (проверить внешний IP = S2)
